...
public class OsebaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println("ZAJ GREM V METODO");
	...
	protected void doPost(HttpServletRequest request,
		...
		if (metoda.equals("prijava")) {
			...
			System.out.println(request.getParameter("ime") + " "
					+ request.getParameter("geslo"));
			...
			uporabnik
					.setTipOsebe(TipOsebe.valueOf(request.getParameter("tip")));
			...
			naslov.setPostnaSt(Integer.parseInt(request.getParameter("posta")));
			naslov.setDrzava(request.getParameter("drzava"));
			naslov.setId(Integer.parseInt(request.getParameter("idNaslov"))); // try
																				// catch
																				// =)
			...
			// v bazi niso povezani, zato je vrstni red brisanja nepomemben -
			// drugace prvo zbrises prijavo! -nova metoda
			if (osebaDAO.izbrisiOsebo(idOsebe))
				stran = "/glavnaVsebina/Domov.jsp"; // placeholder
			else
				// neko opozorilo da ne more zbrisat
				stran = "/glavnaVsebina/Oseba.jsp"; // placeholder
			// naslov izbris?
			...
			prijava.setUpIme(request.getParameter("ime"));
			prijava.setGeslo(request.getParameter("geslo"));
			int idPrijave = osebaDAO.pridobiPrijavo(
					(Integer) seja.getAttribute("ID")).getId();
			prijava.setId(idPrijave);
			String novoGeslo = request.getParameter("gesloN");
			boolean uspesno = osebaDAO.spremeniUporabniskoImeInGeslo(prijava,
					novoGeslo);
